...
/**
 * Created by richashastri29 on 4/19/2017.
 */
...
//
//Purpose: The database class for the connection to the sqlite databse
//
        ...
        try{
            ...
            if(aFile.exists()){
                ...
                if (checkDB!=null) {
                    ...
                    if(crsTabExists){
                        Cursor c= checkDB.rawQuery("SELECT name FROM places;", null);
                        c.moveToFirst();
                        while(! c.isAfterLast()) {
